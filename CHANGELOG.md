...
- Adds local release checks for scaffolding, source profiles, synthetic de-id proof, skill-guide safety anchors, and installed console-command smoke testing.
