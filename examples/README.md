...
These files are synthetic fixtures for testing and demonstration only. They do not contain real patient, staff, site, rota, incident, or organisation-sensitive information.

- `synthetic_ward_audit.csv` exercises deterministic identifier scanning and redaction.
- `synthetic_ed_flow_qip.csv` demonstrates a time-to-assessment run chart.
