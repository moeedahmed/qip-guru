...
QIP Guru is the public product concept. QIP Guru Kit is the open-source repo and toolkit for that concept.
...
| Open-source repo/toolkit | QIP Guru Kit | The public package of templates, source profiles, static skills, synthetic examples, and local checks. |
| Python distribution | `qip-guru-kit` | Public install and package metadata name. |
| Python helper package | `qipkit` | Internal helper package for deterministic local file work. |
...
Use `QIP Guru` when discussing the public product concept or product family.

Use `QIP Guru Kit` when discussing this open-source toolkit and repository.

Use `qip-guru-kit` for Python distribution/package metadata.

Use `qip` for the CLI command and `qipkit` for the Python helper package.

## Release Copy Boundary

Public copy should say:

> QIP Guru Kit helps clinicians and QI teams structure quality-improvement work with source-grounded scaffolds, static agent skill guides, synthetic examples, and local safety checks.
